    ...
    <div class="w-full lg:w-7 mx-auto">
        ...
        <PanelZone>
            <Form :send="createAccount">
                ...
                <FormInput name="password" v-model="newUser.password" required label="Password"
                    autocomplete="new-password" type="password" class="mb-3" />

                <FormInput name="password2" v-model="newUser.password2" required label="Confirm Password"
                    autocomplete="new-password" type="password"
                    :mustMatch="{ field: 'Password', value: newUser.password }" class="mb-3" />

                <Button type="submit" class="w-full"><span class="text-center w-full">
                        <Icon name="ph:user" class="mr-1" /><span class="vertical-align-middle">Create Account</span>
                    </span></Button>
            </Form>
