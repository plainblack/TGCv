<template>
    ...
    <PanelFrame section="Maintenance" title="Edit Maintenance Schedules">
        <template #left>
            ...
            <PanelZone title="Edit Schedule">
                ...
                <FieldsetNav v-if="maintenanceschedule.props">
                    <FieldsetItem name="Properties">
                        ...
                        <div class="mb-4">
                            <FormInput type="select" name="recurrence"
                                :options="maintenanceschedule.options?.recurrence"
                                v-model="maintenanceschedule.props.recurrence" label="Recurrence"
                                @change="maintenanceschedule.save('recurrence')" />
                        </div>
                        <div class="mb-4">
                            <FormInput name="months" type="number" v-model="maintenanceschedule.props.months"
                                label="Months" @change="maintenanceschedule.save('months')" />
                        </div>
                        <div class="mb-4">
                            <FormInput name="weeks" type="number" v-model="maintenanceschedule.props.weeks"
                                label="Weeks" @change="maintenanceschedule.save('weeks')" />
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <FormInput name="description" type="markdown"
                                v-model="maintenanceschedule.props.description" required label="Description"
                                @change="maintenanceschedule.save('description')" />
                        </div>
                    </FieldsetItem>
                    ...
                    <FieldsetItem name="Statistics">
                        ...
                        <div class="mb-4"><b>Created At</b>: {{ formatDateTime(maintenanceschedule.props?.createdAt) }}
                        </div>

                        <div class="mb-4"><b>Updated At</b>: {{ formatDateTime(maintenanceschedule.props?.updatedAt) }}
                        </div>
                    ...
                    <FieldsetItem name="Actions">
                        <NuxtLink :to="`/maintenanceschedule/${maintenanceschedule.props?.id}`" class="no-underline">
                            <Button title="View" alt="View Maintenance Schedule" class="mr-2 mb-2"><i
