        ...
        <template #content>
            ...
            <FieldsetNav v-if="hardwareitemset.props">
                <FieldsetItem name="Properties">
                    ...
                    <div class="mb-4">
                        <FormInput name="name" type="text" v-model="hardwareitemset.props.name" required label="Name"
                            @change="hardwareitemset.save('name')" />
                    </div>
                    <div class="mb-4">
                ...
                <FieldsetItem name="Items">
                    <DataTable :value="hardwareitems.records" stripedRows @sort="(e) => hardwareitems.sortDataTable(e)">

                        <Column field="props.name" header="Name" sortable>
                            <template #body="slotProps">
                                <NuxtLink :to="`/hardwareitems/${slotProps.data.props.id}`" v-ripple>
                        ...
                        <Column header="Manage">
                            <template #body="slotProps">
                                <NuxtLink v-if="slotProps.data.meta?.isOwner"
                                    :to="`/hardwareitems/${slotProps.data.props.id}`" class="mr-2 no-underline">
                                    <Button icon="pi pi-pencil" severity="success" title="Edit"
                                        alt="Edit Hardware Item" />
                                </NuxtLink>
                                <Button v-if="slotProps.data.meta?.isOwner" title="Delete" alt="Delete Hardware Item"
                    ...
                    <Dialog v-model:visible="createItems.visible" maximizable modal header="Header"
                        ...
                        <VForm :send="() => hardwareitems.create()">
                ...
                <FieldsetItem name="Tasks">
                    <DataTable :value="hardwaretasks.records" stripedRows @sort="(e) => hardwaretasks.sortDataTable(e)">
                        ...
                        <Column header="Manage">
                            <template #body="slotProps">
                                ...
                                <Button v-if="slotProps.data.meta?.isOwner" title="Delete" alt="Delete Hardware Task"
                                    icon="pi pi-trash" severity="danger" @click="slotProps.data.delete()" />
                            </template>
                        </Column>
                    </DataTable>
                    ...
                    <Dialog v-model:visible="createTasks.visible" maximizable modal header="Header"
                        ...
                        <VForm :send="() => hardwaretasks.create()">
                            <div class="flex gap-5 flex-column-reverse md:flex-row">
                                <div class="flex-auto">
