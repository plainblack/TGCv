            ...
            <FieldsetNav v-if="user.props?.id">
                ...
                <FieldsetItem name="Profile">
                    ...
                    <div class="mb-4">
                        ...
                        <Avatar :image="user.links?.avatarImage?.href" alt="user avatar" class="h-10rem w-10rem"
                            shape="circle" />
                    </div>
                </FieldsetItem>
                ...
                <FieldsetItem name="Actions">
                    ...
                    <Button @mousedown="become" severity="warning" class="mr-2 mb-2" title="Become" alt="Become User">
                        <<<<<<< HEAD:app/pages/user/admin/[id].vue <Icon name="bi:arrow-left-right" class="mr-1" />
                        Become
                    </Button>
                    <NuxtLink :to="'/user/' + user.props.id + '/profile'">
                        ...
                        <NuxtLink :to="user.links.profile.href">
                            <Button severity="primary" class="mr-2 mb-2" title="View Profile">
                                <Icon name="ph:user" class="mr-1" /> View Profile
                                >>>>>>> f6488bd4b54eb4efd3b0cb5436d5609e084d54c4:app/pages/users/admin/[id].vue
                            </Button>
                        </NuxtLink>
                </FieldsetItem>
