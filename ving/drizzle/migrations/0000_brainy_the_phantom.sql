...
CREATE TABLE `hardwareschedules` (
	...
	`cronJobId` bigint unsigned DEFAULT null,
...
ALTER TABLE `hardwareschedules` ADD CONSTRAINT `hardwareschedules_cronjob_1b3e3efc_fk` FOREIGN KEY (`cronJobId`) REFERENCES `cronjobs`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
